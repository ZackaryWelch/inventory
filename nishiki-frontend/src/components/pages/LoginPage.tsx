...
import { AuthentikLoginButton } from '@/features/auth/components/AuthentikLoginButton/AuthentikLoginButton';
...
export const LoginPage = () => {
  ...
  useEffect(() => {
    ...
    if (!loading && isAuthenticated) {
      console.log('User is authenticated on login page, redirecting to /');
      router.push('/');
    }
    ...
    <>
      ...
      <div className="flex items-center justify-center h-screen">
        <div className="transform flex flex-col items-center justify-center">
          ...
          <AuthentikLoginButton setIsLoading={setIsLoading} />
        </div>
      </div>
    </>
  );
