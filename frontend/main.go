...
func (app *App) createMainUI(b *core.Body) {
	b.Style(func(s *styles.Style) {
		...
		s.Background = ColorGrayLightest // var(--color-gray-lightest)
	})

	// Create main container
	app.mainContainer = core.NewFrame(b)
	app.mainContainer.Style(func(s *styles.Style) {
		s.Direction = styles.Column
		s.Grow.Set(1, 1)
	})
...
func (app *App) showLoginView() {
	...
	loginContainer.Style(func(s *styles.Style) {
		s.Direction = styles.Column
		s.Align.Items = styles.Center
		s.Justify.Content = styles.Center
		s.Grow.Set(1, 1)
		s.Gap.Set(core.Dp(32))
	...
	title.Style(func(s *styles.Style) {
		s.Font.Size = core.Dp(32)
		s.Font.Weight = styles.WeightBold
		s.Color = ColorPrimary // var(--color-primary)
	})

	// Subtitle
	subtitle := core.NewText(loginContainer).SetText("Inventory Management System")
	subtitle.Style(func(s *styles.Style) {
		s.Font.Size = core.Dp(16)
		s.Color = ColorGrayDark // var(--color-gray-dark)
	})
...
func (app *App) showDashboardView() {
	...
	header.Style(func(s *styles.Style) {
		...
		s.Border.Width.Bottom = core.Dp(1)
		s.Border.Color.Bottom = ColorGrayLight // var(--color-gray-light)
	})

	// Header title
	headerTitle := core.NewText(header).SetText("Dashboard")
	headerTitle.Style(func(s *styles.Style) {
		s.Font.Size = core.Dp(20)
		s.Font.Weight = styles.WeightSemiBold
		s.Color = ColorBlack // var(--color-black)
	})
	...
	userBtn.Style(func(s *styles.Style) {
	...
	navContainer.Style(func(s *styles.Style) {
		s.Direction = styles.Row
	...
	statsTitle.Style(func(s *styles.Style) {
		s.Font.Size = core.Dp(18)
		s.Font.Weight = styles.WeightSemiBold
	})

	statsGrid := core.NewFrame(statsContainer)
	statsGrid.Style(func(s *styles.Style) {
		s.Direction = styles.Row
		s.Gap.Set(core.Dp(16))
		s.Wrap = true
	})
...
func (app *App) createStatCard(parent core.Widget, label, value string, cardColor color.RGBA) *core.Frame {
	...
	card.Style(func(s *styles.Style) {
		s.Direction = styles.Column
		s.Align.Items = styles.Center
		s.Background = cardColor
		s.Border.Radius = styles.BorderRadiusMedium
		s.Padding.Set(core.Dp(16))
		s.Gap.Set(core.Dp(4))
		s.Min.X.Set(core.Dp(100))
	})

	valueText := core.NewText(card).SetText(value)
	valueText.Style(func(s *styles.Style) {
	...
	labelText.Style(func(s *styles.Style) {
...
func (app *App) showGroupsView() {
	...
	if len(app.groups) == 0 {
		...
		emptyText.Style(func(s *styles.Style) {
			s.Color = ColorGrayDark // var(--color-gray-dark)
...
func (app *App) showProfileView() {
	...
	if app.currentUser != nil {
		...
		userCard.Style(func(s *styles.Style) {
			s.Direction = styles.Column
			s.Background = ColorWhite
			s.Border.Radius = styles.BorderRadiusLarge
			s.Padding.Set(core.Dp(16))
		...
		usernameLabel.Style(func(s *styles.Style) {
			s.Font.Weight = styles.WeightSemiBold
		...
		emailLabel.Style(func(s *styles.Style) {
			s.Font.Weight = styles.WeightSemiBold
			s.Color = ColorGrayDark
		})
		...
		if app.currentUser.Name != "" {
			...
			nameLabel.Style(func(s *styles.Style) {
				s.Font.Weight = styles.WeightSemiBold
				s.Color = ColorGrayDark
			})
	...
	logoutBtn.Style(func(s *styles.Style) {
		s.Align.Self = styles.Start
		s.Margin.Top = core.Dp(16)
	})
...
func (app *App) createCollectionCard(parent core.Widget, collection Collection) *core.Frame {
	...
	if collection.Description != "" {
		...
		collectionDesc.Style(func(s *styles.Style) {
			s.Font.Size = core.Dp(14)
			s.Color = ColorGrayDark
		})
	}
	...
	objectTypeText.Style(func(s *styles.Style) {
		s.Font.Size = core.Dp(12)
		s.Color = ColorGrayDark
	})
...
func main() {
	...
	core.TheApp.SetAbout("A cross-platform inventory management application built with Cogent Core")
